...
- ✅ ⚙️ Engineering · T1 Model Switch Pause Lock + Choice Hint + Ending Color — removed double-resume bug, added hint display for unlocked choices, end screen red for negative money
- ✅ 📚 Hanlin · T2 Effect Range Values — applyEffect() resolves [min,max] arrays, engine charm-mod refactored, ~25 events converted to ranges, schema updated
- ✅ 🎨 Military · T3 Negative Money Red CSS — .money-negative class, updateUI toggles on state.money<0
- ✅ 🖼️ Chancery · T4 Once Event Fix + Choice Branch Upgrade — execute() only marks once:true as used, 7 choice events upgraded with branch outcomes
...
- ✅ 📚 Hanlin · T2 Part 2 — 取消：复查发现每月choice已达标(min 5/月)，无需补充
...
- ✅ 🎨 Military · T3 UI Layout — controls to explorer, terminal minimized
- ✅ 🎨 Military · HTML/CSS Cleanup (sideGig + audio removal)
- ✅ 🖼️ Chancery · JS Logic Fixes (model switch, sideGig/audio cleanup, editor tab)
- ✅ 📚 Hanlin · Token→Money migration
- ✅ 📚 Hanlin · GAME_DESIGN.md token purge
- ✅ 📚 Hanlin · Design Token Cleanup rework
- ✅ 🎨 Military+Chancery · UI Overhaul
- ✅ 🎨 Military+Chancery · UI Rework (GF UI + model cost)
