...
| 金钱 | `money` | 💰 | 5000 | 0–∞ | 单位：元，使用AI模型直接扣钱 |
...
| 月薪 | `salary` | number | 初始15000，可加薪 |
| 生活费 | `living_cost` | number | 月初扣除，初始5000 |
...
每月固定扣除：
  money -= living_cost（生活费，初始5000）
  money += salary（月薪，初始15000）
```
...
|:---|:---|:---|:---|:---|:---|:---|
| 🐳 豆包 | `doubao` | 1月 | 5/15/30/80M | ¥2 | 45 | 40% |
| 🤖 GPT-5.4 | `gpt54` | 2月 | 20/50/150/400M | ¥8 | 80 | 12% |
| 🎯 Opus 4.6 | `opus46` | 3月 | 35/80/250/600M | ¥12 | 92 | 5% |
| 🔮 DeepSeek V4 | `deepseek_v4` | 4月 | 8/25/60/150M | ¥3 | 72 | 18% |
| 💀 CheapGPT | `cheapgpt` | 3月 | 3/10/20/50M | ¥1 | 30 | 60% |
| 🎪 FakeOpus | `fakeopus` | 5月 | 5/15/35/90M | ¥2 | 35 | 55% |
| 🧠 纯人肉 | — | — | — | — | brain×0.5 | — |

> **费用计算**：每次任务实际花费 = 任务消耗(M) × 单价(¥/M)。
> 例：用 GPT-5.4 做⭐⭐任务 = 50M × ¥8 = ¥400，直接从 `money` 扣除。
...
| 支出项 | 金额 | 频率 | 说明 |
|:---|:---|:---|:---|
| 生活费 | 5000（`living_cost`） | 每月 | 月初自动扣除 |
